...
function jeg_register_theme_customizer($wp_customize) {
    ...
    locate_template(array('/lib/customizer/options/socials.php'),   true, true);  #6
    locate_template(array('/lib/customizer/options/footer.php'),    true, true);  #7
    locate_template(array('/lib/customizer/options/customcss.php'), true, true);  #8
}
